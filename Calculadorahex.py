...
boton_Punto = Button(ventana, text=".", width=5, height=2, command=lambda:click_boton("."), bg="green")
...
boton_igual = Button(ventana, text="=", width=5, height=2, command=lambda:opercacion(), bg="blue")
boton_borrar2 = Button(ventana, text= "<-", width=5, height=2, command=lambda:borrar2(), bg="red")
boton_hex= Button(ventana, text=("HEX"), width=5, height=2, command=lambda: convertir_hexadecimal(), bg="red")
